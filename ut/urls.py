...
urlpatterns = [
    ...
    path('oafc/availability/<str:TeamPlayer_id>',views.PlayerAvailability.as_view(), name='player_availability'),
    path('oafc/availability/<str:TeamPlayer_id>/<int:Game_id>',views.PlayerAvailability.as_view(), name='player_availability'),
